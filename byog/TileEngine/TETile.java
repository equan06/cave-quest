 ...
 * appropriate size (16xn16) to be drawn in place of the unicode representation. If the image path
...
public class TETile implements Serializable {
    ...
    private static final long serialVersionUID = 1111111111124L;
    private final char character; // Do not rename character or the autograder will break.
    private final Color textColor;
    private final Color backgroundColor;
    private final String description;
    private final String filepath;
    private final Color darkTextColor;
    private final Color darkBackColor;
    ...
    public TETile(char character, Color textColor, Color backgroundColor, String description,
        ...
        this.darkTextColor = textColor.darker().darker().darker();
        this.darkBackColor = backgroundColor.darker().darker().darker();
        darkened = false;
    }
    ...
    public TETile(TETile t, Color newTextColor, Color newBackColor) {
        this(t.character, newTextColor, newBackColor, t.description, t.filepath);
    }
    ...
    public void draw(double x, double y) {
        ...
        if (darkened) {
            StdDraw.setPenColor(darkBackColor);
        } else {
    ...
    /**
     * Apply Color.darker() 3 times to text and background color.
     * @param t tile to be modified
     * @return dark version of tile
     */
    public static TETile darkenTile(TETile t) {
        TETile temp = new TETile(t.character, t.textColor, t.backgroundColor, t.description);
        temp.setDark();
        return temp;
    }

    public static TETile brightenTile(TETile t) {
        TETile temp = new TETile(t.character, t.textColor, t.backgroundColor, t.description);
        temp.setBright();
        return temp;
    }
